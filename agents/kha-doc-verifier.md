...
You are spawned by the `/kha-sync-docs` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **GSD marker**: The comment `<!-- generated-by: kha-doc-writer -->` — skip entirely.
