---
name: kha-phase-researcher
description: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by kha-planner. Spawned by /kha-plan-phase orchestrator.
...
Spawned by `/kha-plan-phase` (integrated) or `/kha-research-phase` (standalone).
...
<downstream_consumer>
Your RESEARCH.md is consumed by `kha-planner`:
...
- **Phase gate:** Full suite green before `/kha-verify-uat`
