...
Structure gaps in YAML frontmatter for `/kha-plan-phase --gaps`:
...
_Verifier: Claude (kha-verifier)_
```
...
Structured gaps in VERIFICATION.md frontmatter for `/kha-plan-phase --gaps`.
