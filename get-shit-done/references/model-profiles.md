...
|-------|-----------|------------|----------|------------|-----------|
| kha-planner | opus | opus | sonnet | opus | inherit |
| kha-roadmapper | opus | sonnet | sonnet | sonnet | inherit |
| kha-executor | opus | sonnet | sonnet | sonnet | inherit |
| kha-phase-researcher | opus | sonnet | haiku | sonnet | inherit |
| kha-project-researcher | opus | sonnet | haiku | sonnet | inherit |
| kha-research-synthesizer | sonnet | sonnet | haiku | haiku | inherit |
| kha-debugger | opus | sonnet | sonnet | opus | inherit |
| kha-codebase-mapper | sonnet | haiku | haiku | haiku | inherit |
| kha-verifier | sonnet | sonnet | haiku | sonnet | inherit |
| kha-plan-checker | sonnet | sonnet | haiku | haiku | inherit |
| kha-integration-checker | sonnet | sonnet | haiku | haiku | inherit |
| kha-nyquist-auditor | sonnet | sonnet | haiku | haiku | inherit |
...
```json
{
  ...
  "model_overrides": {
    "kha-planner": "o3",
    "kha-executor": "o4-mini",
    "kha-debugger": "o3",
    "kha-codebase-mapper": "o4-mini"
  }
}
```
...
Runtime: `/kha-set-model-profile <profile>`
