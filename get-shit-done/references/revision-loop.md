...
|----------|---------------|---------------|-------|
| plan-phase | kha-planner | kha-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | kha-executor | kha-verifier | Post-execution verification |
| discuss-phase | orchestrator | kha-plan-checker | Inline revision by orchestrator |
