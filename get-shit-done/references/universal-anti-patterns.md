...
10. **NEVER** use non-KHA agent types (`general-purpose`, `Explore`, `Plan`, `Bash`, `feature-dev`, etc.) -- ALWAYS use `subagent_type: "kha-{agent}"` (e.g., `kha-phase-researcher`, `kha-executor`, `kha-planner`). KHA agents have project-aware prompts, audit logging, and workflow context. Generic agents bypass all of this.
