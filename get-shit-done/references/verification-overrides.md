...
1. Run `/kha-verify-uat` — verification finds gaps
2. Review gaps — determine which are intentional deviations
3. Add override entries to VERIFICATION.md frontmatter
4. Re-run `/kha-verify-uat` — overrides are applied, remaining gaps shown
...
During `/kha-audit-milestone`, overrides are surfaced in the audit report:
