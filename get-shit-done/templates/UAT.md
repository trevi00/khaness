...
- This section feeds directly into /kha-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /kha-plan-phase --gaps with root causes
...
**Creation:** When /kha-verify-uat starts new session
...
- `/kha-verify-uat {phase}` picks up from first pending/blocked test
