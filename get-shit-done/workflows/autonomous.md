...
**If `roadmap_exists` is false:** Error — "No ROADMAP.md found. Run `/kha-new-milestone` first."
**If `state_exists` is false:** Error — "No STATE.md found. Run `/kha-new-milestone` first."
...
```
Skill(skill="kha-clarify-phase", args="${PHASE_NUM}")
```
...
```
Skill(skill="kha-spec-ui-phase", args="${PHASE_NUM}")
```
...
Agent(
  ...
  prompt="Run plan-phase for phase ${PHASE_NUM}: Skill(skill=\"kha-plan-phase\", args=\"${PHASE_NUM}\")"
)
```
...
```
Skill(skill="kha-plan-phase", args="${PHASE_NUM}")
```
...
Agent(
  ...
  run_in_background=true,
  prompt="Run execute-phase for phase ${PHASE_NUM}: Skill(skill=\"kha-execute-phase\", args=\"${PHASE_NUM} --no-transition\")"
)
```
...
```
Skill(skill="kha-execute-phase", args="${PHASE_NUM} --no-transition")
```
...
```
Skill(skill="kha-plan-phase", args="${PHASE_NUM} --gaps")
```
...
```
Skill(skill="kha-review-ui", args="${PHASE_NUM}")
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: /kha-run-milestone --from ${next_incomplete_phase}
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Lifecycle skipped — run /kha-run-milestone without --only
...
```
Skill(skill="kha-audit-milestone")
```
...
On **"Stop"**: Go to handle_blocker with "User stopped — audit gaps remain. Run /kha-audit-milestone to review, then /kha-complete-milestone when ready."
...
On **"Stop"**: Go to handle_blocker with "User stopped — tech debt to address. Run /kha-audit-milestone to review details."

**5b. Complete Milestone**

```
Skill(skill="kha-complete-milestone", args="${milestone_version}")
```
...
```
Skill(skill="kha-archive-completed-phases")
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 Resume with: /kha-run-milestone ${ONLY_PHASE ? "--only " + ONLY_PHASE : "--from " + next_phase}${TO_PHASE ? " --to " + TO_PHASE : ""}
```
...
- [ ] Audit invoked via Skill(skill="kha-audit-milestone")
