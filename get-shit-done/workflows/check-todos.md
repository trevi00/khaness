...
Todos are captured during work sessions with /kha-capture-todo.

---

Would you like to:

1. Continue with current phase (/kha-status)
2. Add a todo now (/kha-capture-todo)
```
...
- `/kha-triage-todos` → show all
- `/kha-triage-todos api` → filter to area:api only
</step>
...
- `/kha-triage-todos [area]` to filter by area
- `q` to exit
```
...
- options:
  - "Work on it now" — move to done, start working
  - "Create a phase" — /kha-add-phase with this scope
  - "Brainstorm approach" — think through before deciding
  - "Put it back" — return to list
</step>
...
**Create a phase:**
Display: `/kha-add-phase [description from todo]`
