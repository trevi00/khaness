...
2. **Run audit first** — `/kha-audit-milestone` to assess gap severity
...
If "Skip": Phase directories remain in `.planning/phases/` as raw execution history. Use `/kha-archive-completed-phases` later to archive retroactively.
...
- [ ] User knows next step (/kha-new-milestone)
