...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /kha-research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/kha-clarify-phase [current-phase])
2. Create phase plan (/kha-plan-phase [current-phase])
