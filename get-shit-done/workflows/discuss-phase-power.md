...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/kha-clarify-phase`.
...
Consider running /kha-clarify-phase {N} again to refine before planning.
```
