...
- kha-phase-researcher — Researches specific questions and returns concise findings
</available_agent_types>
...
- **Phases:** Use existing `/kha-add-phase` command via SlashCommand
...
Continue exploring with `/kha-explore-idea` or start working with `/kha-advance`.
```
