...
Use /kha-run-adhoc for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /kha-run-adhoc instead:
  /kha-run-adhoc "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /kha-run-adhoc
- If you're unsure how to implement it, STOP and redirect to /kha-run-adhoc
</guardrails>
