...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /kha-audit-planning-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /kha-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /kha-audit-planning-health --repair
```
</step>
...
```
Would you like to run /kha-audit-planning-health --repair to fix N issues automatically?
```
