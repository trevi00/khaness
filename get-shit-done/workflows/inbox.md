<!--
kha harness note (2026-06-10): DANGLING / UN-INVOKABLE in this harness.
No command or skill exposes this workflow — gsd-core's `inbox` command was dispositioned
SKIP (single-operator harness has no .github/ISSUE_TEMPLATE inbound-triage need). Kept only
as a vendored upstream file; it is NOT command coverage. Do not re-classify as a new gap.
See example_project-analysis/kha-gsd-gap-CLOSURE-2026-06-09.md §cross-cutting #3.
-->
<purpose>
...
- /kha-review-plan-peer — Run cross-AI peer review on a specific phase plan
- /kha-submit-pr — Create a PR from completed work
- /kha-status — See overall project state
