...
4. If nothing found: error "No milestone found. Run /kha-new-project or /kha-new-milestone first."
...
If the user is done:
- Suggest next steps: `/kha-new-milestone`, `/kha-status`, or sharing the summary with the team
