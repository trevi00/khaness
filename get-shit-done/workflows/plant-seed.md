...
Seeds auto-surface during /kha-new-milestone when trigger conditions match the
...
This seed should be presented during `/kha-new-milestone` when the milestone
...
This seed will surface automatically when you run /kha-new-milestone
