...
Run /kha-new-project to start a new project.
```

Exit.

If missing STATE.md: suggest `/kha-new-project`.

**If ROADMAP.md missing but PROJECT.md exists:**

This means a milestone was completed and archived. Go to **Route F** (between milestones).

If missing both ROADMAP.md and PROJECT.md: suggest `/kha-new-project`.
</step>
...
## Pending Todos
- [count] pending — /kha-triage-todos to review

## Active Debug Sessions
- [count] active — /kha-debug to continue
...
Review: `/kha-audit-uat-backlog ${GSD_WS}` — full cross-phase audit
Resume testing: `/kha-verify-uat {phase} ${GSD_WS}` — retest specific phase
```
...
`/kha-plan-phase {phase-number} ${GSD_WS}`
...
`/kha-clarify-phase {phase}` — gather context and clarify approach

---

**Also available:**
- `/kha-spec-ui-phase {phase}` — generate UI design contract (recommended for frontend phases)
- `/kha-plan-phase {phase}` — skip discussion, plan directly
- `/kha-phase-assumptions {phase}` — see Claude's assumptions
...
`/kha-clarify-phase {phase} ${GSD_WS}` — gather context and clarify approach

---

**Also available:**
- `/kha-plan-phase {phase} ${GSD_WS}` — skip discussion, plan directly
- `/kha-phase-assumptions {phase} ${GSD_WS}` — see Claude's assumptions
...
`/kha-plan-phase {phase} --gaps ${GSD_WS}`

---

**Also available:**
- `/kha-execute-phase {phase} ${GSD_WS}` — execute phase plans
- `/kha-verify-uat {phase} ${GSD_WS}` — run more UAT testing
...
`/kha-verify-uat {phase} ${GSD_WS}` — resume testing from where you left off

---

**Also available:**
- `/kha-audit-uat-backlog ${GSD_WS}` — full cross-phase UAT audit
- `/kha-execute-phase {phase} ${GSD_WS}` — execute phase plans
...
`/kha-clarify-phase {Z+1}` — gather context and clarify approach

---

**Also available:**
- `/kha-spec-ui-phase {Z+1}` — generate UI design contract (recommended for frontend phases)
- `/kha-plan-phase {Z+1}` — skip discussion, plan directly
- `/kha-verify-uat {Z}` — user acceptance test before continuing
...
`/kha-clarify-phase {Z+1} ${GSD_WS}` — gather context and clarify approach

---

**Also available:**
- `/kha-plan-phase {Z+1} ${GSD_WS}` — skip discussion, plan directly
- `/kha-verify-uat {Z} ${GSD_WS}` — user acceptance test before continuing
...
`/kha-complete-milestone ${GSD_WS}`

---

**Also available:**
- `/kha-verify-uat ${GSD_WS}` — user acceptance test before completing milestone
...
- Phase complete but next phase not planned → offer `/kha-plan-phase [next] ${GSD_WS}`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff file exists → mention it, offer `/kha-resume-work ${GSD_WS}`
  </step>
...
- [ ] Smart routing: /kha-execute-phase if plans exist, /kha-plan-phase if not
