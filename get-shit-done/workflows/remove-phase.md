...
- Example: `/kha-remove-phase 17` → phase = 17
- Example: `/kha-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /kha-remove-phase <phase-number>
Example: /kha-remove-phase 17
```
...
To abandon current work, use /kha-pause-work instead.
```
...
Would you like to:
- `/kha-status` — see updated roadmap status
