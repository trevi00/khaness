...
**If `planning_exists` is false:** This is a new project - route to /kha-new-project
</step>
...
- This is the primary resumption source — structured data from `/kha-pause-work`
...
📋 [N] pending todos — /kha-triage-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/kha-execute-phase {phase} ${GSD_WS})
   OR
1. Discuss Phase 3 context (/kha-clarify-phase 3 ${GSD_WS}) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/kha-plan-phase 3 ${GSD_WS}) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/kha-clarify-phase [N] ${GSD_WS}` — gather context first
  - `/kha-research-phase [N] ${GSD_WS}` — investigate unknowns
