<purpose>
Lightweight codebase assessment. Spawns a single kha-codebase-mapper agent for one focus area,
...
Spawn a single `kha-codebase-mapper` agent with the selected focus area:
...
Use `/kha-map-codebase` for a comprehensive 4-area parallel scan.
```
