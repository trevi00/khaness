...
- /kha-complete-milestone (if last phase in milestone)
- /kha-status (to see what's next)
...
- /kha-complete-milestone — if all phases in milestone are done
- /kha-status — see overall project state
- /kha-execute-phase {next} — continue to next phase
</offer_next>
