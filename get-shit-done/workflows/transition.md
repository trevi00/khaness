...
- `/kha-clarify-phase {N}` — discuss a phase before planning
- `/kha-plan-phase {N}` — plan a phase
- `/kha-execute-phase {N}` — execute a phase
- `/kha-status` — see roadmap progress
...
These will carry forward as debt. Review: `/kha-audit-uat-backlog`
```
...
Exit skill and invoke SlashCommand("/kha-plan-phase [X+1] --auto ${GSD_WS}")
...
Exit skill and invoke SlashCommand("/kha-clarify-phase [X+1] --auto ${GSD_WS}")
...
`/kha-clarify-phase [X+1] ${GSD_WS}` — gather context and clarify approach

---

**Also available:**
- `/kha-plan-phase [X+1] ${GSD_WS}` — skip discussion, plan directly
- `/kha-research-phase [X+1] ${GSD_WS}` — investigate unknowns
...
`/kha-plan-phase [X+1] ${GSD_WS}`

---

**Also available:**
- `/kha-clarify-phase [X+1] ${GSD_WS}` — revisit context
- `/kha-research-phase [X+1] ${GSD_WS}` — investigate unknowns
...
`/kha-workstream-manager complete {current_ws_name} ${GSD_WS}`

See overall milestone progress:

`/kha-workstream-manager progress ${GSD_WS}`
...
Do NOT suggest `/kha-complete-milestone` or `/kha-new-milestone`.
...
Exit skill and invoke SlashCommand("/kha-complete-milestone {version} ${GSD_WS}")
...
`/kha-complete-milestone {version} ${GSD_WS}`
