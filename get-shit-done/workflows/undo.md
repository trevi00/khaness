...
```
Usage: /kha-revert-work --last N | --phase NN | --plan NN-MM
...
Examples:
  /kha-revert-work --last 5
  /kha-revert-work --phase 03
  /kha-revert-work --plan 03-02
```
</step>
...
```
Working tree has uncommitted changes. Commit or stash them before running /kha-revert-work.
```
...
**Also available:**
- `/kha-execute-phase ${PHASE}` — re-execute if needed
- `/kha-revert-work --last 1` — undo the revert itself if something went wrong
